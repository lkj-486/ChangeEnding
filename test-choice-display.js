// 测试选择选项显示修复
async function testChoiceDisplay() {
  try {
    console.log('🎮 创建新游戏会话测试选择选项显示...');
    ...
    if (data.success) {
      ...
      console.log('⏰ 等待10秒观察选择点是否正确触发...');
      setTimeout(() => {
        console.log('🎯 10秒已过，选择点应该已经触发');
        console.log('请在浏览器中访问 http://localhost:3000 测试选择选项显示');
      }, 10000);
    } else {
